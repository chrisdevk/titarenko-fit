  ...
  return (
    <article className="bg-turquoise-light">
      <section className="relative overflow-hidden rounded-t-3xl bg-turquoise-dark">
        <div className="relative z-10 mx-auto flex w-11/12 max-w-[1440px] flex-col-reverse items-stretch justify-between gap-x-10 gap-y-5 py-16 md:flex-row">
          ...
          <div className="relative h-[250px] w-full md:w-1/2">
            <Image
        ...
        <div className="absolute -right-[11%] -top-[4%] h-[365px] w-[277px] rotate-90 md:-right-[2.5%] md:-top-[6%]">
